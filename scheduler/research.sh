...
export MACHINE=research
export CORE_PEER_MSPCONFIGPATH=/opt/gopath/src/github.com/hyperledger/fabric/peer/crypto/peerOrganizations/researchorg.university.com/users/Admin@researchorg.university.com/msp
export CORE_PEER_ADDRESS=peer0.researchorg.university.com:7051 
export CORE_PEER_LOCALMSPID="ResearchOrgMSP" 
export CORE_PEER_TLS_ROOTCERT_FILE=/opt/gopath/src/github.com/hyperledger/fabric/peer/crypto/peerOrganizations/researchorg.university.com/peers/peer0.researchorg.university.com/tls/ca.crt
