...
export MACHINE=engineering
export CORE_PEER_MSPCONFIGPATH=/opt/gopath/src/github.com/hyperledger/fabric/peer/crypto/peerOrganizations/engineeringorg.university.com/users/Admin@engineeringorg.university.com/msp
export CORE_PEER_ADDRESS=peer0.engineeringorg.university.com:7051
export CORE_PEER_LOCALMSPID="EngineeringOrgMSP"
export CORE_PEER_TLS_ROOTCERT_FILE=/opt/gopath/src/github.com/hyperledger/fabric/peer/crypto/peerOrganizations/engineeringorg.university.com/peers/peer0.engineeringorg.university.com/tls/ca.crt
