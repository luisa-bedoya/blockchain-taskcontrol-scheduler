...
export MACHINE=exactsciences
export CORE_PEER_MSPCONFIGPATH=/opt/gopath/src/github.com/hyperledger/fabric/peer/crypto/peerOrganizations/exactsciencesorg.university.com/users/Admin@exactsciencesorg.university.com/msp 
export CORE_PEER_ADDRESS=peer0.exactsciencesorg.university.com:7051 
export CORE_PEER_LOCALMSPID="ExactSciencesOrgMSP" 
export CORE_PEER_TLS_ROOTCERT_FILE=/opt/gopath/src/github.com/hyperledger/fabric/peer/crypto/peerOrganizations/exactsciencesorg.university.com/peers/peer0.exactsciencesorg.university.com/tls/ca.crt
